    ...
    namespace detail {
        ...
        namespace get_block_config_impl {
            ...
            class helper_block_ct
            {
                ...
                using optimal_block_config_t =
                    typename database::detail::type_list_element<0, typename block_fft_record_t::blobs>::type;

                // Get optimal (EPT, FPB)
                using optimal_ept = ElementsPerThread<optimal_block_config_t::elements_per_thread>;
                using optimal_fpb = FFTsPerBlock<optimal_block_config_t::ffts_per_block>;

                // Get selected EPT (optimal or provided by user)
                using this_fft_elements_per_thread =
                    get_or_default_t<fft_operator::elements_per_thread, Description, optimal_ept>;
            ...
            public:
                ...
                using suggested_elements_per_thread = optimal_ept;
            ...
            public:
                ...
                // Suggested FPB (for selected EPT)
        ...
        public:
            using type                  = typename get_block_config_impl::helper<Description, false>::block_dim;
        ...
        public:
            using type = typename get_block_config_impl::helper<Description, is_thread_execution>::elements_per_thread;
        ...
        public:
            using type = typename get_block_config_impl::helper<Description, false>::ffts_per_block;
            static constexpr unsigned int value = type::value;

            using suggested_type = typename get_block_config_impl::helper<Description, false>::suggested_ffts_per_block;
        ...
        class check_and_get_fft_implementation
        {
            ...
            using block_config_t = get_block_config_impl::helper<Description, is_thread_execution>;
