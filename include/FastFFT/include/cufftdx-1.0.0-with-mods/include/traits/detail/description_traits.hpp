...
namespace cufftdx {
    namespace detail {
        ...
        struct has_n_of: CUFFTDX_STD::integral_constant<bool, has_n_of_impl::counter<OperatorType, Description>::value == N> {};

        template<fft_operator OperatorType, class Description>
        struct has_at_most_one_of:
            CUFFTDX_STD::integral_constant<bool, (has_n_of_impl::counter<OperatorType, Description>::value <= 1)> {};
        ...
        template<fft_operator OperatorType, class Description>
        struct has_operator:
            CUFFTDX_STD::integral_constant<bool, (has_n_of_impl::counter<OperatorType, Description>::value > 0)> {};
