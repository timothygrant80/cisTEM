...
public:
	...
	virtual bool OpenFile(std::string filename, bool overwrite = false, bool wait_for_file_to_exist = false, bool check_only_the_first_image = false) = 0; // Return true if everything about the file looks OK
