...
void AnglesAndShifts::GenerateEulerMatrices(float wanted_euler_phi, float wanted_euler_theta, float wanted_euler_psi)
{
	...
	cos_phi = cos(deg_2_rad(wanted_euler_phi));
	sin_phi = sin(deg_2_rad(wanted_euler_phi));
	cos_theta = cos(deg_2_rad(wanted_euler_theta));
	sin_theta = sin(deg_2_rad(wanted_euler_theta));
	cos_psi = cos(deg_2_rad(wanted_euler_psi));
	sin_psi = sin(deg_2_rad(wanted_euler_psi));
