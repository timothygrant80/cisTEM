...
public:
	...
	inline void SetHighestFrequencyWithGoodFit(float wanted_frequency_inverse_angstroms) {highest_frequency_with_good_fit = wanted_frequency_inverse_angstroms;};
	//
