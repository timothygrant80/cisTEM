...
public:
	...
	void SetBeamTilt(float wanted_beam_tilt_x_in_radians, float wanted_beam_tilt_y_in_radians);
	...
	float PhaseShiftGivenBeamTilt(float squared_spatial_frequency, float beam_tilt);
