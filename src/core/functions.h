...
int ReturnClosestFactorizedUpper(int wanted_int, int largest_factor, bool enforce_even = false, bool enforce_factor_of_four = false);
int ReturnClosestFactorizedLower(int wanted_int, int largest_factor, bool enforce_even = false, bool enforce_factor_of_four = false);
