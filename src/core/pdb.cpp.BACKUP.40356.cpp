...
>>>>>>> Cleanme: updated master and branched from there on 6/10. Manually pull in changes from simTilt2 because the merge was a mess. Now pull in from reconstruct3d. Then create a new branch from master and pull in the non-simulator changes, test and push
