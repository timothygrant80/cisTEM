...
public:
	...
	void ReadArrayHeader(wxString filename, int &logical_x_dimension, int &logical_y_dimension, int &logical_z_dimension, float &pixel_size, float &average_occupancy, float &average_score, float &score_bfactor_conversion, wxString &symmetry_symbol, bool &insert_even);
