...
/*
class DistributionPlotPanelHistogram : public DistributionPlotPanel
{

public :

	//DistributionHistogram distribution_histogram;

	DistributionPlotPanelHistogram(wxWindow* parent, wxWindowID id = wxID_ANY, const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxDefaultSize, long style = wxTAB_TRAVERSAL, const wxString& name = wxPanelNameStr);
	~DistributionPlotPanelHistogram();
