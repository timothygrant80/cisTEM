...
private:
    bool is_fullscreen;
    // Change this to an enum somewhere if the strategy works as there are likely more than one
    // focus groups in the future. For now, it is a binary (true,SPA or false,TM)
