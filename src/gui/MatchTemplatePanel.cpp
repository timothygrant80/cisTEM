...
void MatchTemplatePanel::StartEstimationClick(wxCommandEvent& event) {
    ...
    current_image_euler_search->InitGrid(wanted_symmetry, wanted_out_of_plane_angular_step, 00.0, 80.0, 360.0, wanted_in_plane_angular_step, 0.0, current_image->pixel_size / resolution_limit, parameter_map, 1);
