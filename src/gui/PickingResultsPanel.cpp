...
*/
	...
	if (DoesFileExist(image_file) == true) ResultDisplayPanel->Draw(image_file,array_of_particle_positions, maximum_radius_of_particle, pixel_size,ctf_of_current_image,current_image_asset->asset_id,iciness);
	RightPanel->Layout();
