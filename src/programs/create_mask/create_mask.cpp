...
void CreateMask::DoInteractiveUserInput()
{
	...
	if (auto_estimate_bin_threshold == false) initial_bin_threshold = my_input->GetFloatFromUser("Wanted initial binarization threshold", "Density will be thresholded at this value initially", "1", 0.0);
