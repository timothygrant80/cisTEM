...
void LocalResolution::DoInteractiveUserInput( ) {
    ...
    wxString input_original_volume = my_input->GetFilenameFromUser("Input original volume", "The original volume input for FSC based filtering", "original_reconstruction.mrc", true);
...
bool LocalResolution::DoCalculation( ) {
    ...
    wxString input_original_volume_fn			= my_current_job.arguments[2].ReturnStringArgument( );
    wxString input_volume_mask_fn               = my_current_job.arguments[3].ReturnStringArgument( );
    wxString output_volume_fn                   = my_current_job.arguments[4].ReturnStringArgument( );
    ...
    int      first_slice                        = my_current_job.arguments[7].ReturnIntegerArgument( );
    int      last_slice                         = my_current_job.arguments[8].ReturnIntegerArgument( );
    int      sampling_step                      = my_current_job.arguments[9].ReturnIntegerArgument( );
    int      box_size                           = my_current_job.arguments[10].ReturnIntegerArgument( );
    bool     use_fixed_threshold                = my_current_job.arguments[11].ReturnBoolArgument( );
    float    fixed_threshold                    = my_current_job.arguments[12].ReturnFloatArgument( );
    float    threshold_snr                      = my_current_job.arguments[13].ReturnFloatArgument( );
    float    confidence_level                   = my_current_job.arguments[14].ReturnFloatArgument( );
    bool     randomize_phases                   = my_current_job.arguments[15].ReturnBoolArgument( );
    ...
    ImageFile input_file_original(input_original_volume_fn.ToStdString( ), false);
    ...
    input_original_volume.ReadSlices(&input_file_original, 1, input_file_original.ReturnNumberOfSlices( ));
