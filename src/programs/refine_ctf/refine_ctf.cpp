...
class ImageProjectionComparisonCTF
{
public:
	Particle *particle;
...
{
	ImageProjectionComparisonCTF *comparison_object = reinterpret_cast<ImageProjectionComparisonCTF *>(scoring_parameters);
...
bool RefineCTFApp::DoCalculation()
{
	...
	ImageProjectionComparisonCTF comparison_object;
