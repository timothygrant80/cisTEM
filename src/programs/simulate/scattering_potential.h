...
private:
	...
	const float  ATOMIC_NUMBER[NUMBER_OF_ATOM_TYPES] = {1.0f, 6.0f, 7.0f, 8.0f, 9.0f, 11.0f, 12.0f, 15.0f, 16.0f, 17.0f, 19.0f, 20.0f, 25.0f, 26.0f, 30.0f, 10.0f, 8.0f, 14.0f, 27.0f, 34.0f, 79.0f};
