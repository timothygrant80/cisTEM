...
void unblur_refine_alignment_object::Update_Running_Average( ) {
...
void unblur_refine_alignment_object::Calculate_Shifts(std::vector<int> target_index, float target_unitless_bfactor) {
    Peak  my_peak;
...
void unblur_refine_alignment_object::Smooth_Shifts( ) {
...
void unblur_refine_alignment_object::Update_SumImage( ) {
    this->sum_of_images.SetToConstant(0.0);
...
std::vector<int> unblur_refine_alignment_object::SearchOutlierIndices( ) {
...
void unblur_refine_alignment_object::alignment_refine(bool use_smoothed_shifts) {
