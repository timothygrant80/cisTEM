        ...
        if ( round_index == 1 ) {
            ...
            if ( distortion_model == 2 || distortion_model == 1 ) {
                ...
                */
                ...
                patch_trimming_basedon_locations(image_stack, patch_stack, number_of_input_images, patch_num_x, patch_num_y, output_stack_box_size, outputpath.ToStdString( ), "patch_pix", max_threads, true, false, patch_locations);
